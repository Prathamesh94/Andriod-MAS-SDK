...
/**
 * Interface for receiving a callback result from {@link MobileSso#processRequest(com.ca.mas.core.http.MASRequest, ResultReceiver)}.
 * Use this by creating a subclass and implement {@link #onSuccess(MASResponse <T>)}, {@link #onError(MAGError)},
 ...
 *           {@link com.ca.mas.core.http.MASRequest.MASRequestBuilder#responseBody(MASResponseBody)}
 */
